import React, { VFC, memo, Dispatch, SetStateAction } from 'react';
...
interface Props {
  ...
  delete_user_by_pk: DeleteUserMutationFn;
...
const UserItem: VFC<Props> = ({ user, delete_user_by_pk, setEditedUser }) => {
  return (
    <div className="my-1">
